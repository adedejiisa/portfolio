...
function renderPost(post, container) {
  ...
  ` : ""} ${getCountryFlagEmoji(user.country)}</strong><br>
    ...
    <div class="post-actions">
      <button class="action-btn love-btn ${(post.likes || []).includes(currentUserId) ? "liked" : ""}">
        <svg class="icon" viewBox="0 0 24 24">
              <path d="M12 21s-7-4.35-9.5-8.5C.4 8.4 2.5 5 6 5c2 0 3.4 1.1 4 2.1C10.6 6.1 12 5 14 5c3.5 0 5.6 3.4 3.5 7.5C19 16.65 12 21 12 21z"/>
            </svg>
